// Keeping icons as thin, focused components rather than pulling in
// a full icon library for just 5 icons. Each one is a named export
// so tree-shaking can drop anything we stop using.
...
export const IconFolder = () => (
  <svg
    ...
    strokeLinecap="round"
    strokeLinejoin="round"
    style={{ width: 28, height: 28, fill: "none", color: "var(--accent)" }}
  >
